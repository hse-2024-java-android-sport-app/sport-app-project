...
public class TrainingEventsAdapter extends BaseAdapter<TrainingEventDto, BaseAdapter.BaseViewHolder<TrainingEventDto>> {

    public TrainingEventsAdapter(List<TrainingEventDto> items, OnItemClickListener<TrainingEventDto> listener) {
